...
public class PostController {
	...
	@RequestMapping(value = "/{url}/preview", method = RequestMethod.GET)
	@ResponseBody
	public String previewComment(@PathVariable("url") String url, @RequestHeader("content") String comment) {
